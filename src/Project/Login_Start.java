...
public class Login_Start extends javax.swing.JFrame {
    static String url = "jdbc:mysql://localhost:3306/reception";
...
if(passw.equals(pass1))
    ...
    private void initComponents() {
        ...
        usern.setFont(new java.awt.Font("Segoe UI Light", 0, 16)); // NOI18N
        usern.setForeground(new java.awt.Color(0, 102, 102));
...
getPass();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Login_Start.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
